    ...
    return (
      <section className="md:pb-1 sm:px-6 md:px-12">
        <div className="text-center">
          <h1 className="font-poppins text-6xl mb-6 sm:pt-12 md:pt-24">Library</h1>
        ...
        <div className="flex flex-col sm:pt-12 mt-12 md:pb-0 md:mt-24 md:flex-row md:items-center">
          ...
          <button className="ml-12 mr-auto text-3xl sm:hidden md:block">
            <ion-icon name="filter"></ion-icon>
          </button>

          <SearchBar />

          <button className="ml-auto text-3xl md:hidden mb-6">
            <ion-icon name="filter"></ion-icon>
          </button>
        </div>

        <PaginatedItems label='Programming' data={books} />
      </section>
    );
}