...
const Footer = () => {
  return (
    <footer className="dark:bg-thinDark bg-veryLightGray py-12">
      <div className="flex flex-col-reverse px-6 justify-between md:px-12 lg:flex lg:flex-row h-full">
        <div className="">
          <h2 className="dark:text-lightGray text-center text-4xl font-bold font-alegreya mb-6 md:text-left md:mt-0">
            Developers
          </h2>
          ...
          <div className="flex flex-col md:flex md:flex-row items-center mb-2">
            ...
            <div className="flex my-6 md:my-0  md:ml-auto">
              <button className="dark:bg-brown mx-2 text-lg flex items-center bg-lightBrown p-1 rounded-full">
                <ion-icon name="logo-twitter"></ion-icon>
              </button>
              <button className="dark:bg-brown text-lg flex items-center bg-lightBrown p-1 rounded-full">
          ...
          <div className="dark:text-veryLightGray flex flex-col md:flex md:flex-row items-center text-center">
            <p className="mb-6 text-lg font-inter  md:mb-0">Atologun Kelvin</p>
            <div className=" flex dark:text-darkMoon md:ml-auto">
              <button className="dark:bg-brown mx-2 text-lg flex items-center bg-lightBrown p-1 rounded-full">
                <ion-icon name="logo-twitter"></ion-icon>
              </button>
              <button className="dark:bg-brown text-lg flex items-center bg-lightBrown p-1 rounded-full">
        ...
        <div className="">
          ...
          <button className="dark:bg-brown font-poppins bg-lightBrown my-6 px-1 py-2 flex items-center justify-center text-lg rounded-lg">
            Follow BOOKLY
            <span className="dark:bg-darkMoon dark:text-veryLightGray flex items-center justify-center text-lg p-2 bg-veryLightGray rounded-full mx-2">
              <ion-icon name="logo-twitter"></ion-icon>
            </span>
          </button>
        </div>

        <div className="w-full lg:w-1/3 py-6 md:py-0">
